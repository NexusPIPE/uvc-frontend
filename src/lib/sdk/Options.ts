...
export const i18n = {
  "human": {
    ...
    "hi": ["मैं रोबोट नहीं हूं", "मैं इंसान हूं", "मैं रोबोट नहीं हूं", "मैं एक इंसान हूं"],
    ...
    "ja": ["私はロボットではありません", "私は人間です", "私はロボットではありません", "私は人間です"],
    "pa": ["ਮੈਂ ਰੋਬੋਟ ਨਹੀਂ ਹਾਂ", "ਮੈਂ ਇਨਸਾਨ ਹਾਂ", "ਮੈਂ ਰੋਬੋਟ ਨਹੀਂ ਹਾਂ", "ਮੈਂ ਇੱਕ ਇਨਸਾਨ ਹਾਂ"],
    "de": ["Ich bin kein Roboter", "Ich bin ein Mensch", "Ich bin kein Roboter", "Ich bin ein Mensch"],
    "fr": ["Je ne suis pas un robot", "Je suis humain", "Je ne suis pas un robot", "Je suis un humain"],
    "it": ["Non sono un robot", "Sono umano", "Non sono un robot", "Sono un umano"],
    "id": ["Saya bukan robot", "Saya manusia", "Saya bukan robot", "Saya seorang manusia"],
    "tr": ["Ben bir robot değilim", "Ben bir insanım", "Ben bir robot değilim", "Ben bir insanım"],
    "sq": ["Unë nuk jam robot", "Unë jam njeri", "Unë nuk jam robot", "Unë jam njeri"]
  },
  "slide": {
    "en": [
